...
<body>
    ...
    <p>O Mercado Central, anteriormente denominado Mercado Municipal de Belo Horizonte, é um mercado localizado no
        Centro de Belo Horizonte, na cidade de Belo Horizonte, no Brasil. Foi criado em 7 de setembro de 1929 pelo então
        prefeito Cristiano Machado. Pertenceu à Prefeitura de Belo Horizonte até 1964.[1] Seu galpão ocupa um quarteirão
    ...
    <p>Cristiano Machado fundou o Mercado em 1929. Na época, o mercado era um campo aberto, com barracas simples.
        ...
        O Mercado funcionou perfeitamente até 1964, quando o prefeito Jorge Carone resolveu vender o terreno, alegando
        impossibilidade de administração. Cristiano Machado, juntamente com alguns comerciantes, comprou o mercado, para
        que a venda a terceiros fosse evitada. No entanto, os compradores enfrentaram, imediatamente, um primeiro
        empecilho: teriam que construir um galpão coberto, na área total do antigo mercado, dentro de um prazo de cinco
        anos. Caso não conseguissem, teriam que devolver a área à Prefeitura. A cada dia, novas dificuldades impediram o
        início da construção. A 15 dias do prazo dado pela prefeitura, ainda faltava o fechamento do mercado.
        Foi então que os irmãos Osvaldo, Vicente e Milton de Araújo, fundadores do Banco Mercantil do Brasil, decidiram
        ...
        Marteleto. Para que o galpão pudesse ser fechado no prazo estabelecido, foram contratadas quatro construtoras,
